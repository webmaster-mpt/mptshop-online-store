...
<body>
        ...
        <div class="grap">
        <?php
        foreach ($tovarsMy as $tovarMy) 
        {
        ?>
        <div class="card">
                
                <div class="card-image"><img src="/uploads/<? echo  
                $tovarMy->photo_tovar;?>" alt="" width="100%" height="100%"></div>
                <div class="card-text">
                        <span class="date"><? echo  $tovarMy->name;?></span>
                        <h2>─────────────</h2>
                        <h2><? echo  $tovarMy->brand;?></h2>
                        <p><? echo  $tovarMy->size;?></p>
                        <p><? echo  $tovarMy->color;?></p>
                </div>
        ...
        ?>  
        <div class="card">
                <div class="card-image"><img src="/uploads/<? echo  $tovarAll->photo_tovar;?>" alt="" width="100%" height="100%"></div>
                <div class="card-text">
